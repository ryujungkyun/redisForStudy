...
/*
    1. NX : ZADD leaderboard NX 100 Alice (SETNX)

    2. XX : ZADD leaderboard XX 150 Bob (SETXX)

    3. GT : ZADD leaderboard GT 200 Charlie (SETGT)

    4. LT : ZADD leaderboard LT 50 Dave (SETLT)

    5. CH : Score가 변경된 요소도 포함

    6. INCR : ZINCRBY -> ZADD leaderboard INCR 20 Alice
*/

/*
    1. ZRANGE : ZRANGE leaderboard 0 -1 WITHSCORES

    2. ZREVRANGE : ZREVRANGE leaderboard 0 -1 WITHSCORES

    3. ZRANK : ZRANK leaderboard Alice

    4. ZREVRANK : ZREVRANK leaderboard Alice
*/
